...
import { Card, Button, Stack, Layout, TextContainer, Heading } from '@shopify/polaris';
...
const IdeaContainer = () => {
  ...
  for (let i = 0; i < 3; i++) {
    cards.push(<IdeaCard key={"card" + JSON.stringify(i)} layerr={{ layer: i }} />);
  };
...
function IdeaCard(props) {
    const leftPercentage = (JSON.stringify(props.layerr.layer * 3.33) + "%");
